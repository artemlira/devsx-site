...
if (have_posts()) : while (have_posts()) : the_post();
    ...
    <div class="container">
      ...
      <div class="hero-content">
        ...
        <div class="post-meta">
          ...
          <p class="post-date"><span>Posted: </span><?php echo get_the_date('j M Y'); ?></p>
        </div>
        ...
        <div class="reading-time">
          ...
          <p>Reading time: <?php echo $reading_time; ?> mins</p>
        </div>
      </div>
  </section>
  ...
  <section class="related-posts">
    <div class="container">
      <div class="caption-text color-blue wow fadeInUp">blog</div>
      ...
      <div class="btn-wrap">
        <a class="btn-blue-text" href="/blog">
          Explore More
