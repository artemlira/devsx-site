...
function devsx_register_acf_blocks()
{
  ...
  $blocks = [
    ...
    [
      'slug' => 'career-life-devsx',
      'title' => __('DevsX - Career Life at DevsX Section', 'devsx'),
      'description' => __('Heading, subtitle and text', 'devsx'),
      'icon' => 'cover-image',
      'keywords' => ['life', 'devsx', 'career']
    ],
    [
      'slug' => 'about-ideas',
